...
public:
	 ...
	 */
	void DrawLine2D(const Mat4x4& ortho, const Vec2f& fromPosition, const Vec4f& fromColor, const Vec2f& toPosition, const Vec4f& toColor);
	 ...
	 * @param color 선의 색상입니다.
	 */
	void DrawLines2D(const Mat4x4& ortho, const std::vector<Vec2f>& positions, const Vec4f& color);
	 ...
	 */
	void DrawEllipse2D(const Mat4x4& ortho, const Vec2f& center, float xAxis, float yAxis, float rotate, const Vec4f& color, int32_t sliceCount = 300);
	 ...
	 * @param sliceCount 타원 둘레의 절단 횟수입니다. 기본 값은 300입니다.
	 */
	void DrawWireframeEllipse2D(const Mat4x4& ortho, const Vec2f& center, float xAxis, float yAxis, float rotate, const Vec4f& color, int32_t sliceCount = 300);
